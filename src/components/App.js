...
const Seed = ({id, team}) => (
    <div className="seed">
        <p>{id === 1 ? "1st" : id === 2 ? "2nd" : id === 3 ? "3rd" 
            : id === 4 ? "WC" : id === 5 ? "WC" : id === 6 ? "WC" 
            : id === 7 ? "Out" : id === 8 ? "Out" : null}</p>
...
function App() {
    ...
    return (
        <div id="main-container">
            ...
            <div id="source">
                <a href="https://kroljs.com" target="_blank" rel="noreferrer noopener">kroljs.com/mlb-seeds-2022</a>
            </div>
            ...
            <div id="references">
                ...
                <span><p>[2]</p><a href="https://www.mlb.com/news/mlb-playoff-tiebreaker-rules" target="_blank" rel="noreferrer noopener">mlb.com</a></span>
            </div>
        </div>
    );
}
